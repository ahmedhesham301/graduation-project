      ...
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "user",
              content: `Validate signup name "${form.name}" email "${form.email}". If valid email (has @ and dot) respond ONLY with JSON: {"ok":true,"msg":"Account created! Welcome to 3Karati, ${form.name}."} else {"ok":false,"msg":"Invalid email address."}. No markdown.`,
            },
          ],
        }),
      });
