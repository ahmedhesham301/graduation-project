...
export default function ProfileSettings() {
  ...
  // Force full-screen coverage on mount
  useEffect(() => {
    const root = document.getElementById("root");
    document.documentElement.style.cssText = "width:100%;height:100%;margin:0;padding:0;background:#f5f3ef;";
    document.body.style.cssText = "width:100%;height:100%;margin:0;padding:0;background:#f5f3ef;";
    if (root) root.style.cssText = "width:100%;min-height:100vh;background:#f5f3ef;";
    return () => {
  ...
  return (
    <div className="ps-app">
      ...
      <aside className="ps-sidebar">
        <div className="ps-sidebar-back">
          <IconChevronLeft /> settings
        </div>
        <nav className="ps-sidebar-nav">
          ...
          <button className="ps-nav-item logout" style={{ marginTop: "auto" }}>
            <IconLogout /> Log out
          </button>
        </nav>
      </aside>
      ...
      <main className="ps-main">
        ...
        <div className="ps-topbar">
          <div>
            ...
            <p className="ps-welcome-date">Fri, 19 Dec 2025</p>
          </div>
          ...
          <div className="ps-form-stack">
            ...
            <div className="ps-field-group">
              ...
              <div className="ps-phone-row">
                <div className={`ps-phone-code${!editMode ? " disabled" : ""}`}>
                  🇪🇬 +20
                </div>
                <input
                  className="ps-field-input ps-phone-input"
                  type="tel"
